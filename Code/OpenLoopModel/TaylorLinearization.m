function [LinearMatrix, EqPoints] = TaylorLinearization(VehicleSpeed, Tslope,Tbrake)
m = 3875*0.45359; % Vehicle Curb Weight in kg % 4000
...
Jw = 4.0; % Moment of Inertia for Wheel Assembly % 4.2
ksus = 700*57.3; % Suspension Stiffness in Nm/rad %1500
bsus = 220; % Suspension Damping in Nm/(rad*sec) % 200
...
vs = VehicleSpeed*0.44704/rw; % convert mph to rad/s
Tb = Tbrake;
Tslp = Tslope;
